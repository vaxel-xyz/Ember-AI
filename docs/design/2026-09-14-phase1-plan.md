...
**Spec:** `/Users/jtotham/Projects/superpowers/specs/2026-09-14-ember-ai-design.md` (read it first; both of Jon's ADRs are summarised there and the URL ADR lives at `Ember-AI/ADR — Vaxel Service URLs, Ownership and Network Architecture.md`).
...
- Public names: gateway `https://llm.vaxel.xyz/v1`, dashboard `https://ember.vaxel.xyz`. `ai.vaxel.xyz` is **never** referenced as an Ember endpoint.
